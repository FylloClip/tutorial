...
The bootloader is a small program which need to be present on a microcontroller chip to be used in the Arduino environment. The bootloader enables the chip to receive code via the USB connection (using the Arduino IDE).
