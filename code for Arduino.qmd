...
[Arduino code](https://github.com/FylloClip/tutorial/blob/main/docs/Arduino%20code/FylloClip_2025/FylloClip_2025.ino)
...
As soon as you start the serial terminal, the menu shown in the above screenshot appears. It will remain active only for a few seconds, after which the board goes into sleep mode. You can reactivate the menu by closing the serial terminal and opening it again. Then insert immediately the one of the letters of the possible options in the menu, followed by 'enter'.
...
a - allows you to set the desired time interval with the following options: 01-05-10-15-20-30-60 minutes. Please enter always double digits, e.g. 05 instead of 5. A time interval of 10 minutes has proved to be appropriate.
