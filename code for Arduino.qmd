...
The ABP mode of activating the device requires 3 unique identification codes to be inserted into the sketch before uploading it to the device. These are the **device address**, the **application session key** and the **network session key**. You will obtain these codes when creating a new end device on the TTS console, after you will have created your own personal account there.
