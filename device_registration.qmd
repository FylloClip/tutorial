...
To enter the payload formatter for the application, select Payload formatters –\> Uplink and then *Custom Javascript formatter* as formatter type. In the field *Formatter code* paste the follwing code:
