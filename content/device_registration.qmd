...
![](../images/clipboard-3505957760.png){width="539"}
...
Move the cursor to the right side of the key fields to activate the formatting options, the change the format as follows. At the end copy each key using the copy function and insert them in the respective positions of the [Arduino sketch](https://github.com/FylloClip/tutorial/blob/main/resources/Arduino%20code/FylloClip_2025/FylloClip_2025.ino).
