...
The design for this PCB can be downloaded [here](https://github.com/FylloClip/tutorial/blob/main/resources/PCB%20production%20files/Bootloader/Gerber_bootloader.zip). In addition to the PCB you need two 28-pin sockets, two 10K resistors, two 16 MHz crystals, four 22pF capacitors and a 6-pin header pin. The process of burning a bootloader will be exactly the same as described above. Of course you will need a ATmega328 chip with Arduino Uno bootloader already present to start with.
