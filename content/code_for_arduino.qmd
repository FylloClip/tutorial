...
![*part of the Arduino sketch with the ID- number in line 11 and the identification keys in lines 15, 18 and 21.*](../images/sketch.png){width="1000"}
...
![*TinyLora library*](../images/tinylora.png)

![*select the correct frequency band for your region by commenting/uncommenting the respective lines of code*](../images/frequency_settings.png){width="600"}
